...
date=$(date +"%Y-%m-%d")
NameUser=$(curl -s http://lnd.red-flat.my.id:81/shahwjusisjsnajakajannaiajanajam  | grep $MYIP )
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/bokir-tampan/userbackup.git
    git push -f https://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@github.com/bokir-tampan/userbackup.git &> /dev/null
}
...
link="https://raw.github.com/bokir-tampan/userbackup/main/$NameUser/$NameUser.zip"
sleep 1
